# Spring-Boot CXF JAXWS QuickStart also with Camel Rest Component

Combined the archetypes of cxf and camel-rest to show that it is relatively easy
to have a Spring boot camel app which exposes both a cxf SOAP service and a camel-servlet using
the camel rest DSL. 
